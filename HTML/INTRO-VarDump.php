            ...
            <div class="container-child">
                ...
                <div class="box-child">
                    ...
                    <div class="sub-context">
                       <p class="marg-bot">One of the built-in functions in PHP is the var_dump() function. This function displays structured information such as type and the value of one or more expressions given as arguments to this function.</p>
                       <p class="marg-bot">var_dumxed $value, mixed ...$values): voidp(mi</p>
                       <p class="marg-bot">This function returns all the public, private and protected properties of the objects in the output. The dump information about arrays and objects is properly indented to show the recursive structure.</p>
                       <p>For the built-in integer, float and Boolean variables, the var_dump() function shows the type and value of the argument variable.</p>
                    </div>
                </div>
                <div class="box-child">
                    <div class="sub-header1">
                    ...
                    <div class="sub-context dark-syntax">
                        ...
                        <p><span class="numbers">2.</span><span class="yellow">$x = array("Lambeosaurus", false, 99.99, array(10, 20, 30));</span></p>
                        <p><span class="numbers">3.</span><span class="yellow"> var_dump ($x);</span></p>
                        <p><span class="numbers">4.</span><span class="yellow"></span></p>
                        <p><span class="opse-numbers">7.</span><span class="pink">?&gt</span></p>
                    </div>
                </div>
                <div class="box-child">
                    <div class="sub-header1">
