            ...
            <div class="container-child">
                ...
                <div class="box-child">
                    ...
                    <div class="sub-context">
                        <p class="marg-bot">Data types in PHP can be of "scalar type" or "compound type". Integer, float, Boolean and string types are scalar types, whereas array and object types are classified as compound types. Values of more than one type can be stored together in a single variable of a compound type.</p>
                        <p class="marg-bot">In PHP, objects and arrays are the two compound data types.</p>
                        <p class="marg-bot">An array is an ordered collection of elements of other data types, not necessarily of the same type.</p>
                        <p class="marg-bot">An object is an instance of either a built-in or a user defined class, consisting of properties and methods.</p>
                        <p class="marg-bot">Accessing Array Elements</p>
                        <p class="marg-bot">To access any element from a given array, you can use the array[key] syntax. For an indexed array, put the index inside the square bracket, as the index itself is anyway the key.</p>
                    </div>
                </div>
                <div class="box-child">
                    <div class="sub-header1">
                    ...
                    <div class="sub-context dark-syntax">
                        ...
                        <p><span class="numbers">2.</span><span class="yellow">$arr1 = [4, 4, 23];</span></p>
                        <p><span class="numbers">3.</span><span class="yellow">$arr2 = array("one"=>1, "two"=>18, "three"=>1);</span></p>
                        <p><span class="numbers">4.</span><span class="yellow">var_dump($arr1[1]);</span></p>
                        <p><span class="numbers">5.</span><span class="yellow">var_dump($arr2["two"]);</span></p>
